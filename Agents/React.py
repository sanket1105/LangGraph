...
class AgentState(TypedDict):
    """A TypedDict that defines the state of the agent.

    Attributes:
        messages: A sequence of BaseMessage objects annotated with add_messages
                 to enable message accumulation in the state graph.
    """
...
inputs2 = {
    "messages": [
        HumanMessage(content="Add 0 + 12 and then multiply the result by 100.")
    ]
}
